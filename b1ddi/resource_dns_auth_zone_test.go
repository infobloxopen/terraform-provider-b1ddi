...
func resourceDnsAuthZoneBasicTestStep(t *testing.T) resource.TestStep {
	return resource.TestStep{
		...
		Check: resource.ComposeAggregateTestCheckFunc(
			...
			resource.TestCheckResourceAttr("b1ddi_dns_auth_zone.tf_acc_test_auth_zone", "tags.TestType", "Acceptance"), resource.TestCheckResourceAttr("b1ddi_dns_auth_zone.tf_acc_test_auth_zone", "transfer_acl.#", "0"),
